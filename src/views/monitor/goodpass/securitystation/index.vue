    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
              ...
              <el-row>
                <el-col :span="20">
                  <el-table v-loading="loading" :data="form.privates"
                    ...
                    style="font-size: 8px"
                    :header-cell-style="{ fontSize: '6px',height:'16'}"
      ...
      <el-row :gutter="24">
        <el-col :span="8">
          ...
          <el-col :span="6">
          <el-form-item :label="emps" prop="carrierin" required>
            <el-input v-model="form.carrierin" placeholder="请输入請填車牌號碼"
            @blur="getcarrierin" />
          </el-form-item>
        </el-col>
          <el-col :span="8">
...
<script>
import { listReleaseGood, getReleaseGood, delReleaseGood, addReleaseGood, updateReleaseGood, exportReleaseGood }
...
export default {
  ...
  data() {
    return {
      ...
      options2: [{
        value: '4',
        label: '00:00~07:00 管制時段'
      }, {
        value: '5',
        label: '07:00~21:00 一般時段'
      }, {
        value: '6',
        label: '21:00~24:00 管制時段'
      }],
      options3: [{
        value: '7',
