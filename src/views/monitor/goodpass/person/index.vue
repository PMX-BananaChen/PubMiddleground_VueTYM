    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="info"
                   ...
                   size="mini"
                   v-hasPermi="['system:Person:import']"
...
<script>
import { listPerson, getPerson, delPerson, addPerson, updatePerson, exportPerson }
from "@/api/goodpass/Person";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除PH2人员编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有PH2人员数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
